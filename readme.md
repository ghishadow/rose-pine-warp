<p align="center">
    ...
    <h2 align="center">Rosé Pine for Warp</h2>
</p>
...
1. Open `~/.warp/themes`
2. Copy all rosepine_*.yaml to `~/.warp/themes/`
3. Select `Rosé Pine` from the themes dropdown

## Gallery

![Rosé Pine with Warp](https://user-images.githubusercontent.com/1474821/166155319-06796439-95a7-4aea-910e-927c1f24518e.png)
